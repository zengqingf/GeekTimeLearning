...
--3.@注意：需要使用LuaLib_2.dll（使用的5.3.6）对应版本的lua.exe c:\Users\tenmove\.vscode\extensions\actboy168.lua-debug-1.41.0\runtime\windows\x86\lua53\lua.exe 