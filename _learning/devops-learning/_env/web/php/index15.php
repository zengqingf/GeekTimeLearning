...
<plist version="1.0">
    ...
    $plist_str_tail = '</string>
                ...
                <dict>
                    ...
                    <string>com.tm.dnl15.dev</string>
                    <key>bundle-version</key>
                    <string>1.0.0</string>
                    <key>kind</key>
                    <string>software</string>
                    <key>title</key>
                    <string>1.5(内部链接下载中..)</string>
                </dict>
            </dict>
        </array>
    </dict>
...
if ($DEVICETYPE !== "android")
{
    ...
    for ($i = 0; $i < $len; $i++)
    {
        ...
        if (strncmp($basename, "ios_DNL15", strlen("ios_DNL15")) == 0)
        {
...
if ($DEVICETYPE !== "ios")
{
    ...
    for ($i = 0; $i < $len; $i++)
    {
        ...
        if (strncmp($basename, "android_DNL15", strlen("android_DNL15")) == 0)
        {
...
if ($DEVICETYPE !== "ios" && $DEVICETYPE !== "android")
{
    ...
    for ($i = 0; $i < $len; $i++)
    {
        ...
        if (strncmp($basename, "win_", strlen("win_")) == 0 ||
            strncmp($basename, "mac_", strlen("mac_")) == 0
        )
        {
