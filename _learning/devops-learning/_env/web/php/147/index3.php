...
<plist version="1.0">
    ...
    $plist_str_tail = '</string>
                ...
                <dict>
                    ...
                    <string>com.tm.tmnb.dev</string>
                    <key>bundle-version</key>
                    <string>1.0.0</string>
                    <key>kind</key>
                    <string>software</string>
                    <key>title</key>
                    <string>tmnb(内部链接下载中..)</string>
                </dict>
            </dict>
        </array>
    </dict>
...
if ($DEVICETYPE !== "android")
{
    ...
    for ($i = 0; $i < $len; $i++)
    {
        ...
        if (strncmp($basename, "TMNBH5_ios", strlen("TMNBH5_ios")) == 0)
        {
...
if ($DEVICETYPE !== "ios")
{
    ...
    for ($i = 0; $i < $len; $i++)
    {
        ...
        if (strncmp($basename, "TMNBH5_android", strlen("TMNBH5_android")) == 0)
        {
...
if ($DEVICETYPE !== "ios" && $DEVICETYPE !== "android")
{
    ...
    for ($i = 0; $i < $len; $i++)
    {
        ...
        if (strncmp($basename, "TMNBH5_WIN", strlen("TMNBH5_WIN")) == 0 ||
            strncmp($basename, "TMNBH5_MAC", strlen("TMNBH5_MAC")) == 0
        )
        {
