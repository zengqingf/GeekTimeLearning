...
* [[Unity]面试题整理](https://www.jianshu.com/p/0e721df4a622)
  ...
  */
  ...
  答：作用就是Alpha混合。公式：最终颜色 = 源颜色源透明值 + 目标颜色（1 - 源透明值）
