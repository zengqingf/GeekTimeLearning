...
public class TDM : ModuleRules
{
	...
	public TDM(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        else if (Target.Platform == UnrealTargetPlatform.Win64)
        {
			...
			//PublicDelayLoadDLLs.Add(Path.Combine(ModuleDirectory,"lib","Win64", "TDataMaster.dll"));
            /*
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "TDataMaster.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "pthreadVC2.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "pthreadGC2.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "libssl-1_1.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "libssh2.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "libcurl.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "libcrypto-1_1.dll"), Target);
			CopyDllAndLibToProjectBinaries(Path.Combine(ModuleDirectory,"lib","Win64", "zlibwapi.dll"), Target);
            */
