...
extern bool CreateUserWidgetBaseLuaTemplateFile(UBlueprint* Blueprint);
...
private:
    ...
    TSharedRef<FExtender> GetBlueprintToolbarExtender(const TSharedRef<FUICommandList> CommandList, const TArray<UObject*> ContextSensitiveObjects)
    {
        ...
        NewCommandList->MapAction(FUnLuaEditorCommands::Get().CreateUserWidgetBaseLuaTemplate, FExecuteAction::CreateLambda([Blueprint]() { CreateUserWidgetBaseLuaTemplateFile(Blueprint); }), FCanExecuteAction());
    ...
    void AddToolbarExtension(FToolBarBuilder &ToolbarBuilder)
    {
        ...
        ToolbarBuilder.AddToolBarButton(Commands.CreateUserWidgetBaseLuaTemplate);
