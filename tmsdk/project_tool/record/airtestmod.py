...
if __name__ == "__main__":
    # libpath = sys.argv[1]
    libpath = r'D:\_workspace\_project\_sdk\DevOps_Scripts\pyscripts\recordproj\venv\Lib\site-packages'
    ...
    if os.path.exists(airtestpath):
        ...
        # minicap的miui11问题
        com.combinefolder(airtestpath,os.path.join(thisdir,'fix','airtest'))
