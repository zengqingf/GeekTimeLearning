...
namespace UnrealBuildTool
{
	static class ActionGraph
	{
		...
		/// </summary>
		public static void ExecuteActions(BuildConfiguration BuildConfiguration, List<Action> ActionsToExecute, TargetDescriptor targetDescriptor=null)
		{
			...
			else
			{
                ...
                {
                    Executor = new FASTBuild(targetDescriptor);
                }
                //#endif
