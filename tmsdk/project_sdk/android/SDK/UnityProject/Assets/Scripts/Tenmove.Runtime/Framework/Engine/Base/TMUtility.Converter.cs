...
namespace Tenmove.Runtime
{
    public static partial class Utility
    {
        ...
        {
            private const float CONST_INCHES_TO_CENTIMETERS = 2.54f; // 1 inch = 2.54 cm
            private const float CONST_CENTIMETERS_TO_INCHES = 1f / CONST_INCHES_TO_CENTIMETERS; // 1 cm = 0.3937 inches
            ...
            public static float GetCentimetersFromPixels(float pixels)
            {
                ...
                return CONST_INCHES_TO_CENTIMETERS * pixels / ScreenDpi;
            }
            ...
            public static float GetPixelsFromCentimeters(float centimeters)
            {
                ...
                return CONST_CENTIMETERS_TO_INCHES * centimeters * ScreenDpi;
            }
