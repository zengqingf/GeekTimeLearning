...
import com.tm.dnl15.GameApplication;
 ...
 */
public class LBApplication extends GameApplication {
    private boolean exec = true;

    @Override
    public void onCreate() {
        // 切勿修改此方法！！请修改你们自己的Application类，如有疑问请和乐变联系
    ...
    protected void attachBaseContext(Context base) {
        ...
        GlobalSettings.init(base);//初始化全局配置
