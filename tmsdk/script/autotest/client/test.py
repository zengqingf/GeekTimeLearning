...
# 'adb -s xxx logcat -f log.log '
from comlib.comobj import G_timemark,G_timemark_datetime

import subprocess,signal

import ctypes

TestHelper.back('6EB0217808004166')

# pid = TestHelper.getPID('6EB0217808004166','com.tenmove.a8.dev')
# proc = TestHelper.openLogcat('6EB0217808004166','tt.log',pid)
# time.sleep(10)
# TestHelper.closeLogcat(proc)



# proc = TestHelper.openLogcat('6EB0217808004166','test2.log')
# time.sleep(5)
# print(proc.pid)
