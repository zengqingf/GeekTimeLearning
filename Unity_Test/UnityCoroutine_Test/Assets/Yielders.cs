...
//    yield return new WaitForSecondsRealtime(1.0f);    =>      yield return Yielders.GetWaitForSecondsRealtime(1.0f);
...
public static class Yielders
{
	...
	public static WaitForSecondsRealtime GetWaitForSecondsRealtime(float seconds)
	{
		...
		WaitForSecondsRealtime wfsrt;
		if (!_waitForSecondsRealtimeYielders.TryGetValue(seconds, out wfsrt))
			_waitForSecondsRealtimeYielders.Add(seconds, wfsrt = new WaitForSecondsRealtime(seconds));
		return wfsrt;
	}
